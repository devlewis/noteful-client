...
class AddNote extends React.Component {
    ...
    handleSubmit = e => {
        ...
        const folder = this.context.folders.find(({ name }) => name === folderNameChoice);
    ...
    render() {
        ...
        const folderName = this.context.folders.map(folder => <option value={folder.name}>{folder.name}</option>)
        ...
        return (
            <section className='AddNote'>
                ...
                <form
                    ...
                    <div>
                        <label htmlFor='folderNameChoice'>
                            Folder {' '}
                        </label>
                        <select
                            onChange={e => this.setState({ folderNameChoice: e.target.value })}
